...
func getRoutes() http.Handler {
	...
	mux.Get("/admin/reservations/{src}/{id}/show", Repo.AdminSingleReservation)
	mux.Post("/admin/reservations/{src}/{id}/", Repo.AdminPOSTSingleReservation)
	mux.Get("/admin/process-reservations/{src}/{id}/show", Repo.AdminProcessReservation)
	mux.Get("/admin/delete-reservations/{src}/{id}/show", Repo.AdminDeleteReservation)
