...
func routes(app *config.AppConfig) http.Handler {
	...
	mux.Get("/user/logut", handlers.Repo.Logut)
	...
	mux.Route("/admin", func(mux chi.Router) {
		...
		mux.Post("/reservations/{src}/{id}/", handlers.Repo.AdminPOSTSingleReservation)
		mux.Get("/process-reservations/{src}/{id}/show", handlers.Repo.AdminProcessReservation)
		mux.Get("/delete-reservations/{src}/{id}/show", handlers.Repo.AdminDeleteReservation)
